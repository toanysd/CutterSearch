(function() {
  ...
  function setupUI() {
    ...
    var enterFullscreenBtn = document.getElementById('enterPseudoFullscreen');
    var exitFullscreenBtn = document.getElementById('exitPseudoFullscreen');
    ...
    document.getElementById('updateLocationBtn').addEventListener('click', function() {
      if (selectedIdx >= 0) {
        alert('位置更新機能 / Chức năng cập nhật vị trí');
      }
    });
    
    document.getElementById('updateShipBtn').addEventListener('click', function() {
      if (selectedIdx >= 0) {
        alert('搬送更新機能 / Chức năng cập nhật vận chuyển');
      }
    });
    
    document.getElementById('addNoteBtn').addEventListener('click', function() {
      if (selectedIdx >= 0) {
        alert('メモ機能 / Chức năng ghi chú');
      }
    });
  }
