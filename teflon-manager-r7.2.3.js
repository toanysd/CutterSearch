...
(function () {
  ...
  // ========================================================================
  function buildRows() {
    console.log('[TeflonManager r7.2.3] buildRows called');
  ...
  function applyFilterAndSort() {
    ...
    // ✅ r7.2.3: Reset to page 1 on filter/sort change
    currentPage = 1;
...
`;
  ...
  function injectStyles() {
    if (document.getElementById('teflon-manager-r7-2-3-styles')) return;

    const link = document.createElement('link');
    link.id = 'teflon-manager-r7-2-3-styles';
    link.rel = 'stylesheet';
    link.href = 'teflon-manager-r7.2.3.css';
  ...
  function renderTable() {
    ...
    // ✅ r7.2.3: Calculate pagination range
...
<script>window.print();</script>
  ...
  // ========================================================================
  // OPEN PANEL (r7.2.3: WITH PAGINATION BUTTONS)
  // ========================================================================
  function openPanel() {
    console.log('[TeflonManager r7.2.3] openPanel called');
...
<div class="vi">Gửi email</div>
  ...
  // ========================================================================
  function INIT() {
    console.log('[TeflonManager r7.2.3] Initializing...');
    console.log('[TeflonManager] ✅ PAGINATION FIX: 50 rows/page');
    console.log('[TeflonManager] ✅ CSS: teflon-manager-r7.2.3.css');
    injectStyles();
    initNavButton();
...
/**
 * ========================================================================
 * END OF FILE - teflon-manager-r7.2.3.js
 * ========================================================================
 * 
 ...
 *    - Added goToPage(), previousPage(), nextPage() functions
 *    - Added pagination buttons (◀ 前 / Next ▶) in actions bar
 *    - Added updatePaginationButtons() to enable/disable buttons
 *    - Added updateSummaryBar() with page info (Page 1/10)
 *    - Reset to page 1 on filter/sort change
 * 
 * ✅ SCROLL FIX:
 *    - Table now renders max 50 rows → proper height
 *    - Vertical scroll works because table fits in container
 *    - No more "183 meters tall table" issue
 * 
 * ✅ ALL r7.2.2 FEATURES PRESERVED:
 *    - Nav badge with kanji (発/承/中)
 *    - Horizontal scroll lock/unlock
 *    - Filter 2-line layout
 *    - Clickable mold name + status badge
 *    - CSV export with BOM
 *    - Process manager integration
 *    - All buttons and layouts
 * 
 * COMPARISON WITH OTHER MODULES:
 * 
 * | Module          | Render Strategy      | Rows/Page | Scroll |
 * |-----------------|----------------------|-----------|--------|
 * | ResultsTable    | Pagination           | 50        | ✅     |
 * | HistoryView     | Limit + Load More    | 100       | ✅     |
 * | MobileTableView | Pagination           | 20        | ✅     |
 * | TeflonManager   | Pagination (NEW)     | 50        | ✅     |
 * 
 * DEPENDENCIES:
 *    - CSS: teflon-manager-r7.2.3.css (same as r7.2.2)
 *    - window.DataManager (molds, teflonlog, employees)
 *    - window.TeflonProcessManager (optional)
 * 
 * USAGE:
 *    1. Include CSS: <link rel="stylesheet" href="teflon-manager-r7.2.3.css">
 *    2. Include JS: <script src="teflon-manager-r7.2.3.js"></script>
